...
main: main.cpp knightarc.cpp magearc.cpp dragonarc.cpp input.cpp quest_map.cpp welcome.cpp dragon.o knight.o mage.o hero.o enemy.o
	g++ main.cpp knightarc.cpp magearc.cpp dragonarc.cpp input.cpp quest_map.cpp welcome.cpp dragon.o knight.o mage.o hero.o enemy.o -o main
	./a.out
...
# Automated tests
test:
	clang++ dragon.cpp knight.cpp mage.cpp hero.cpp enemy.cpp main.cpp knightarc.cpp magearc.cpp dragonarc.cpp input.cpp quest_map.cpp welcome.cpp
	./a.out
